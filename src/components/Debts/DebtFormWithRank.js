...
class DebtFormWithRank extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      rank: this.props.rank ? this.props.rank : '', 
  ...
  handleChangeInterest(event) {
   ...
   handleChangeRank(event) {
      this.setState({rank: parseFloat(event.target.value) });
  }
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <label style={style.item}>
         ...
         <label style={style.item}>
          <span style={style.itemName}>Rank:</span>
          <input type="number" style={sharedStyles.input} value={this.state.rank} onChange={this.handleChangeRank} />
        </label>
...
export default DebtFormWithRank; 